...
.filter {
        ...
        function handleSearch() {
            ...
            searchTimeout = setTimeout(function() {
                ...
                if (query) { // If there's content in the search bar
                    $.post("search1.php", { input: query }, function(data) { 
    ...
    var query = document.getElementById("search-input").value; // Get the current search query
    $.post("search1.php", { input: query, page: page }, function(data) {
